...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
        <img class="img-fluid" src="<?= base_url('assets'); ?>/img/profile.png" alt="">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto">
            <p>Blabalb balbalba blabalbala ablalaba balabls ablabdal sbdslabdlasbdlab sdlabdla dlbaldbadbabdlkabs dlabsdl asbdl asbdlas dlsakbdlasbdlas dlasb dlasb dla dlkasbdl sabld asd</p>
          </div>
        </div>
      </div>
    </section>
